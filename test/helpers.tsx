...
export function expectExactType<T>(_t: T) {
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  return <U extends Equals<T, U>>(_u: U) => {};
}
